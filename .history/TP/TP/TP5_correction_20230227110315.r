...
# * @Date: 2023-02-27 09:46:17
# * @LastEditTime: 2023-02-27 10:25:56
# * @LastEditors: ThearchyHelios
# * @Description: 
# * @FilePath: /STA401/TP/TP/TP5_correction.r
# */
...
#---------question 4--------------------------
# Calculer les moyennes en ligne de Mdata. Soit avec rowMeans() soit avec apply(Mdata,MARGIN=1,mean)
# et les affecter `a moyennes. Afficher ce dernier objet dans lequel on trouve les N r´ealisations de ¯Xn.
rowMeans(Mdata) -> moyennes
